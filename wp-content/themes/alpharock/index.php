	...
	<nav class="fh5co-nav" role="navigation">
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="https://alpharock.com/" title="Alpharock Holding Company" rel="home" class="main-logo"><img src="http://alpharock.loc/wp-content/themes/alpharock/assets/images/AR-Logo.png" alt="Alpharock Holding Company" class="logo-img" data-no-retina 
   style="width: 185px;"></a></div>					</div>
					<div class="col-xs-10 text-right menu-1">
						<ul>
							<li class="active"><a href="index.html">HOME</a></li>
							<li><a href="practice.html">TEAM</a></li>
							<li><a href="won.html">HOW WE WORK</a></li>
							<li><a href="won.html">INVESTMENT STRATEGIES</a></li>
							<li><a href="won.html">CONTACT</a></li>
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1>DELIVERING POSITIVE
SOCIAL & ENVIRONMENTAL IMPACT
THROUGH TRANSITIONAL LENDING AND ALTERNATIVE ASSET MANAGEMENT</h1>
		   ...
		   <li style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/img_bg_2.jpg);">
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1>ALTERNATIVE INVESTMENT FIRM WITH OUTCOME-FOCUSED SOLUTIONS</h1>
		   ...
		   <li style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/img_bg_3.jpg);">
		   		...
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1>FOCUSED ON PERFORMANCE AND STEWARDS FOR INVESTORS CAPITAL</h1>
		   ...
		   <li style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/img_bg_4.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
			   				<div class="slider-text-inner">
			   					<h1>ALTERNATIVE INVESTMENT STRATEGIES
FOR
SUSTAINABLE RETURNS</h1>
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/Max.png" alt="Free HTML5 Templates by gettemplates.co">
						<h3>MAX SHISHLYANNIKOV</h3>
					
						<strong class="role">Managing Partner</strong>
						<p>Max Shishlyannikov is the founder and Chief Executive Officer of Alpharock Holding Company, LLC. Prior to founding Alpharock Holding, Mr Shishlyannikov was a Chief Investment of Orbis Asset Management, LLC – a company aimed to provide attractive risk return opportunities to investors in the lending space.</p>
				...
				<div class="col-md-4 col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/Jim-Pettit.png" alt="Free HTML5 Templates by gettemplates.co">
						<h3>JAMES PETIT</h3>
						<strong class="role">Managing Partner</strong>
						<p>Co-founder and Managing Partner of Venture Capital firm Navitas Capital from September 2008 to Present – raising and actively managing Navitas I, LP and Navitas II, LP. Within this capacity, Jim is focused on early-stage investments with respect to technology solutions applied to the physical world, with a focused mandate on real estate and construction technologies.</p>
						<ul class="fh5co-social-icons">
							<li><a href="#"><i class="icon-facebook"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
				...
				<div class="col-md-4 col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/Rustam-1.jpg" alt="Free HTML5 Templates by gettemplates.co">
						<h3>RUSTAM AKTUGANOV</h3>
						<strong class="role">Managing Director, Private Credit Operations</strong>
						<p>Rustam Aktuganov is the managing director and responsible for private credit operations of the company. Mr. Aktuganov has been active for more than 25 years in the field of project-related leadership, with a focus in technical start-ups and real estate development. Taking different roles, such as CEO, managing partner, board director’s member, he has proven experience in managing projects, programs and project portfolios in complex and dynamic contexts. </p>
						<ul class="fh5co-social-icons">
							<li><a href="#"><i class="icon-facebook"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
				...
				</div><div class="col-md-4 col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/John-small.png" alt="Free HTML5 Templates by gettemplates.co">
						<h3>JOHN PICARD</h3>
						<strong class="role">Managing Director, Strategy</strong>
						<p>John Picard is a visionary and design innovator who understood the “internet of things” long before connectivity became the driver that it is today. Celebrated for his keen understanding of the innovative principles of natural system designs, John connects visionary thinking with emerging technologies to drive successful projects for corporations, commercial buildings, college campuses, and even entire towns.</p>
						<ul class="fh5co-social-icons">
							<li><a href="#"><i class="icon-facebook"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
					...
					<div class="fh5co-staff">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/Arthur.jpg" alt="Free HTML5 Templates by gettemplates.co">
						<h3>ARTHUR COHEN</h3>
						<strong class="role">Managing Director, Investor Relations</strong>
						<p>Mr. Cohen’s background specializes in ROI management. Mr. Cohen analyses the current overall financial picture of a firm and creates increased ROI utilizing new technologies in the specific market place. Mr. Cohen has over 26 years in client management across various sectors of business. Mr. Cohen is licensed by the Department of Insurance and Department of Business Oversite.</p>
						<ul class="fh5co-social-icons">
							<li><a href="#"><i class="icon-facebook"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
				...
				<div class="col-md-4 col-sm-4 text-center animate-box" data-animate-effect="fadeIn">
					<div class="fh5co-staff">
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/Emily.png" alt="Free HTML5 Templates by gettemplates.co">
						<h3>EMILY ZHANG</h3>
